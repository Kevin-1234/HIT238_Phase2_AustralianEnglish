...
import { StyleSheet, View, FlatList, Text, Button, TouchableOpacity, ImageBackground } from 'react-native';
...
export default function PhraseNote({navigation}) {
    ...
    if(phraseList.length <= 0){
        ...
        return (
            ...
            <FlatList style={styles.list} data={phraseList} renderItem={({ item }) => (
              <TouchableOpacity>
