...
export default function Slangs({ navigation }) {
  ...
  const slangData = [
    ...
    },
    {
      ...
      key: "4",
      definition:
        "A tropical fruit with hard, dark green skin, soft, light green flesh and a large seed inside.",
    ...
    },
    {
      ...
      key: "5",
      definition:
        "Dog's eye is a pie with a filling of meat and/or other savory ingredients.",
...

    {
      ...
      key: "7",
      definition:
        "A portable insulated container for keeping food and drink cool.",
