...
export default function Home({ navigation }) {
  ...
  const topics = [
    {
      ...
      key: "1",
      description:
        "We are going to talk about food and that is why we have come to a restaurant.....",
    ...
    },
    {
      ...
      key: "2",
      description:
        "We are going to talk about families, our partners, our children, our siblings and parents.....",
...

    {
      ...
      key: "4",
      description:
        "Vocabulary for food and cooking can get technical, so, familiarise yourself with some commonly used words.....",
    ...
    },
    {
      ...
      key: "5",
      description:
        "I have been bitten by the travel bug, so, i am going to go the beach for a holiday.....",
    ...
    },
    {
      ...
      key: "6",
      description:
        "Have you checkd the forecast today? let's talk about the temperature.....",
  ...
  return (
    <Container>
      ...
      >
        Swipe the card left or right to switch the topic
      </Text>
    </Container>
  );
}
